...
def main():
    ...
    if request.method == 'POST':
        ...
        proline  =  request.form['proline']        #Putting Form input in a data frame         
        input_variables = pd.DataFrame([[alcohol, malic_acid, ash, alcalinity_of_ash, magnesium, total_phenols, flavanoids, 
